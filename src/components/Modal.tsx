...
const Modal = ({ result, closeModal, title }: ModalProps) => {
  return (
    <motion.div
      ...
      className='fixed w-[80%] aspect-video max-lg:w-[90%]  max-md:aspect-[3/4] max-md:w-[80%]   max-md:max-h-[90%] max-[480px]:w-[90%] max-[480px]:h-[80%] left-[50%] top-[50%] shadow-xl z-50 bg-opacity-85 filter'
      style={{
